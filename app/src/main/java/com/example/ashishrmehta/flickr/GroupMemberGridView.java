...
public class GroupMemberGridView extends GridView {
    ...
    private static class HeaderViewGridAdapter implements WrapperListAdapter, Filterable {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (DEBUG) {
//                FinLog.d(LOG_TAG, String.format("getView: %s, reused: %s", position, convertView == null));
            }
            // Header (negative positions will throw an ArrayIndexOutOfBoundsException)
            int numHeadersAndPlaceholders = getHeadersCount() * mNumColumns;
            if (position < numHeadersAndPlaceholders) {
        ...
        public int getItemViewType(int position) {
            ...
            if (DEBUG) {
//                FinLog.d(LOG_TAG, String.format("getItemViewType: pos: %s, result: %s", position, type, mCachePlaceHoldView, mCacheFirstHeaderView));
            }
            return type;
        }
        ...
        public int getViewTypeCount() {
            ...
            if (DEBUG) {
//                FinLog.d(LOG_TAG, String.format("getViewTypeCount: %s", count));
            }
            return count;
        }
